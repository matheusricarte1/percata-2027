// ============================================================
// PERCATA — Tipos de Domínio
// Espelha o modelo de dados do Supabase + Lei 14.133
// ============================================================

export type Campus = "petrolina" | "ouricuri";

export type Role = "usuario" | "chefia" | "chefia_lab" | "admin" | "superadmin";

export type GND = string;
...
export type DFDItemStatus =
  | "ativo"
  | "removido_chefia"
  | "abandonado_corte_pca";
...
export interface ItemEfisco {
  ...
  tipo_objeto?: "MATERIAL" | "SERVIÇO" | string;
  codigo_grupo?: string;
  nome_grupo?: string;
...
export interface CarrinhoItem {
  ...
  source_kit_nome?: string;
  source_kit_descricao?: string;
}
